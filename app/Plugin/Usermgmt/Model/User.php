...
class User extends UserMgmtAppModel {
	 ...
	 * @var array
	 */
	var $hasMany = array('LoginToken'=>array('className'=>'Usermgmt.LoginToken','limit' =>1), 'Machines' => array('className' => 'UsersMachines'));
	//var $hasMany = array('Usermgmt.UsersMachines');
	/**
